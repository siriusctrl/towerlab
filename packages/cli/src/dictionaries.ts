...
export const localeText = {
  en: {
    ...
    controlsReferenceClosed: "d deck, l library",
    controlsReferenceOpen: "d deck, l library, [ ] section, ↑/↓ or j/k scroll, esc close",
  ...
  zh: {
    ...
    controlsReferenceClosed: "d 查看牌组，l 查看图鉴",
    controlsReferenceOpen: "d 牌组，l 图鉴，[ ] 切段，↑/↓ 或 j/k 滚动，esc 关闭",
